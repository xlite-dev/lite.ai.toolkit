...
Run `bash ./build.sh tensorrt` to build lite.ai.toolkit with TensorRT support, and then test yolov5 with the codes below. Please check [build.sh](./build.sh), [tensorrt-linux-x86_64-install.zh.md](https://github.com/DefTruth/lite.ai.toolkit/blob/v0.3.0/docs/tensorrt/tensorrt-linux-x86_64.zh.md) and [test_lite_yolov5.cpp](https://github.com/DefTruth/lite.ai.toolkit/blob/main/examples/lite/cv/test_lite_yolov5.cpp) for more details.
```c++
